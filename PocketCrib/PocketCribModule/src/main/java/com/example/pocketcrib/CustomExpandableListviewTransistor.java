...
public class CustomExpandableListviewTransistor extends BaseExpandableListAdapter {
    ...
    public CustomExpandableListviewTransistor(Context context, List<String> expandableListTitle, HashMap<String, List<String>>
    ...
    public View getChildView(int listPosition, final int childPosition,
        ...
        DatabaseReference transistor = FirebaseDatabase.getInstance().getReference("Transistor");

        transistor.addValueEventListener(new ValueEventListener() {
...
//                    Paper.book().write(Common.NUMBER, number);
                            ...
                            if (Integer.valueOf(number) == 0) {
                                ...
                                Item item = new Item(text, number, "Transistor");
                                item.setKey(items.get(childPosition).getKey());
                                arrayList.add(item);
                                Paper.book().write(Common.ITEM_TRANSISTOR, arrayList);
                                Paper.book().write(Common.ITEM_TRANSISTOR_REQ_FRAG, arrayList);
                            }

//                    Paper.book().write(Common.ITEM_NAME, text);
//                    Paper.book().write("aa",arrayList);
...
//                    Paper.book().delete(Common.NUMBER);
//                    Paper.book().delete(Common.ITEM_NAME);
